...
API_ID = int(environ.get("API_ID", "27332436"))
API_HASH = environ.get("API_HASH", "e4e48674defb04a12d480bed130c5243")
...
ADMINS = [
    ...
    for admin in environ.get("ADMINS", "5906503038").split()
]
OWNER_USERNAME = environ.get(
    "OWNER_USERNAME", "mxf5a"
)  # without @ or https://t.me/
USERNAME = environ.get("USERNAME", "mxf5a")  # ADMIN USERNAME
...
# MongoDB
DATABASE_URI = environ.get("DATABASE_URI", "mongodb+srv://aditya295:<db_password>@aditya99.fese7to.mongodb.net/?retryWrites=true&w=majority&appName=aditya99")
DATABASE_NAME = environ.get("DATABASE_NAME", "aditya99")

# Files index database url
FILES_DATABASE = environ.get("FILES_DATABASE", "mongodb+srv://aditya295:<db_password>@aditya99.fese7to.mongodb.net/?retryWrites=true&w=majority&appName=aditya99")
COLLECTION_NAME = environ.get("COLLECTION_NAME", "jisshu")

# Other Channel's
SUPPORT_GROUP = int(environ.get("SUPPORT_GROUP", "-4844678426"))
DELETE_CHANNELS = int(environ.get("DELETE_CHANNELS", "0"))
request_channel = environ.get("REQUEST_CHANNEL", "-4959194724")
REQUEST_CHANNEL = (
    int(request_channel)
...
MOVIE_GROUP_LINK = environ.get("MOVIE_GROUP_LINK", "https://t.me/+zKjL4eLWdGYzZWQ1")

# Verification
IS_VERIFY = is_enabled("IS_VERIFY", True)
# ---------------------------------------------------------------
TUTORIAL = environ.get("TUTORIAL", "https://t.me/HowToUseBoTx/4")
TUTORIAL_2 = environ.get("TUTORIAL_2", "https://t.me/HowToUseBoTx/4")
TUTORIAL_3 = environ.get("TUTORIAL_3", "https://t.me/HowToUseBoTx/4")
...
SHORTENER_API2 = environ.get(
    "SHORTENER_API2", "1cfaa58d4673734700e452a1afc9aa379ab93f74"
)
SHORTENER_WEBSITE2 = environ.get("SHORTENER_WEBSITE2", "papajiurl.com")
SHORTENER_API3 = environ.get(
    "SHORTENER_API3", "af044cddcc4212300ca6d3b0a0356ee2ead5d094"
)
